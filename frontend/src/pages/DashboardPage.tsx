                                ...
                                <Stack gap="sm">
                                    <Group justify="space-between">
                                        <Group gap="sm">
                                            ...
                                            <Text size="sm">John Doe joined the Engineering team</Text>
                                        </Group>
                                    ...
                                    <Group justify="space-between">
                                        <Group gap="sm">
                                            ...
                                            <Text size="sm">Monthly newsletter sent to all employees</Text>
                                        </Group>
                                        <Text size="xs" c="dimmed">
                                            1 day ago
                                        </Text>
                                ...
                                <Card padding="lg" radius="md" withBorder>
                                    ...
                                    <Center>
                                        <RingProgress
                                            ...
                                            thickness={16}
                                            sections={[
                                                { value: 40, color: 'blue', tooltip: 'Engineering - 40%' },
                                                { value: 25, color: 'green', tooltip: 'Sales - 25%' },
                                                { value: 20, color: 'orange', tooltip: 'Marketing - 20%' },
