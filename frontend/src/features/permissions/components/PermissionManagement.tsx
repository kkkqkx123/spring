            ...
            <Stack gap="lg">
                ...
                <Group grow>
                    ...
                    <Card withBorder>
                        <Group justify="space-between">
                            <div>
                                <Text size="sm" c="dimmed">Total Permissions</Text>
                                <Text size="xl" fw={700}>{permissions.length}</Text>
                            </div>
                ...
                {/* Main Content */}
                <Tabs value={activeTab} onChange={(value) => setActiveTab(value || 'matrix')}>
                    <Tabs.List>
                        <Tabs.Tab
                            value="matrix"
                ...
                {/* Help Section */}
                <Alert icon={<IconInfoCircle size={16} />} title="Permission Management Guide">
                    <Stack gap="xs">
                        <Text size="sm">
                            • Use the <strong>Role-Permission Matrix</strong> to manage which permissions each role has
                        </Text>
                        <Text size="sm">
                            • Use <strong>User Role Assignment</strong> to assign roles to users and manage user access
                        </Text>
                        <Text size="sm">
                            • Use <strong>Custom Roles</strong> to create specialized roles with specific permission combinations
                        </Text>
                        <Text size="sm">
                            • Changes to permissions may affect multiple users - review impact analysis before confirming
                        </Text>
                    </Stack>
                </Alert>
            </Stack>
